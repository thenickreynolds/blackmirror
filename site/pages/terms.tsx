    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <p>
            Your privacy is important to us. It is Gday Today's policy to
            respect your privacy regarding any information we may collect from
            you across our website,{" "}
            <a href="http://gday.today">http://gday.today</a>, and other sites
            we own and operate.
          </p>
          <p>
      ...
      <footer className={styles.footer}>Nothing to see here</footer>
    </div>
  );
}
